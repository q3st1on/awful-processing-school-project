...
void advancedStats() {
  ...
  textSize(20);
  text("AVERAGE SIZES: ", 560, 215);
  textSize(15);
  text("HIT TARGETS: "+ sizeh+"px", 560, 235);
  text("MISSED TARGETS: "+ sizem+"px", 560, 255);
  int sizetolav = 0;
  int stvcount = 0;
  ...
  text("ALL TARGETS: "+ sizetolav/stvcount+"px", 560, 275);
  textSize(20);
  text("TOTAL SCORE: "+ (3019-(((maxtargetsize*(maxtargetsize/mintargetsize)*(timer.duration/1000)))+tm)), 560, 310);
}
